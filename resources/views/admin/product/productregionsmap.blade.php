                ...
                <table class="min-w-full bg-white border border-gray-200 rounded-lg">
                    <thead>
                        <tr class="bg-gray-100 text-gray-700">
                            ...
                            <th class="py-3 px-6 border-b text-center">Product Region Code</th                            <th class="py-3 px-6 border-b text-center"></th>
                    ...
                    <tbody>
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="py-2 px-6 border-b">{{ $region->productregionsname }}</td>
                        ...
                        @empty
                        <tr>
                            <td colspan="5" class="py-2 px-4 text-gray-500 text-center">No regions found.</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
