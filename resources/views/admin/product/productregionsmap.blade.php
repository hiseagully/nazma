...
<div class="flex min-h-screen border border-gray-200">
    ...
    <!-- Sidebar -->
    <x-adminsidebar :activeMenu="'product'" :activeSubMenu="'productregionsmap'" />
    <!-- Main content -->
                ...
                <table class="min-w-full bg-white border border-gray-200 rounded-lg">
                    <thead>
                        <tr class="bg-gray-100 text-gray-700">
                            ...
                            <th class="py-3 px-4 border-b text-center">Region Code</th>
                            <th class="py-3 px-4 border-b text-left">Region Name</th>
                    ...
                    <tbody>
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="py-2 px-4 border-b flex justify-center gap-2 text-center">
                                ...
                                <form action="{{ route('productregionsmap.destroy', $region->productregionsid) }}" method="POST" onsubmit="return confirm('Delete this region?')" class="inline">
                                    @csrf
                                    @method('DELETE')
...
<div id="addModal" class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-30 hidden">
    <div class="bg-white rounded-lg shadow-lg w-full max-w-md p-6 relative">
        ...
        <form action="{{ route('productregionsmap.store') }}" method="POST">
            @csrf
            <div class="mb-4">
                <label class="block text-sm mb-1">Region Code</label>
...
<script>
    ...
    function openEditModal(id, code, name) {
        ...
        document.getElementById('editForm').action = '/productregionsmap/' + id;
    }
